...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
    // Functions for setting up the FTDI chip FT232H
	/////////////////////////////////////////////////////////////////////////////////////
    MFRC522(QObject *parent = 0);
    ...
    const QString GetStatusCodeName(byte code);
	byte PICC_GetType(byte sak);

    const QString PICC_GetTypeName(byte type);
    // Support functions for debuging
    void PCD_DumpVersionToSerial();
    //TODO DumpDetailsToSerial
    ...
    // atp  functions
    /////////////////////////////////////////////////////////////////////////////////////
    byte PCD_NTAG216_AUTH(byte *passWord, byte pACK[]);
signals:
    void atpNewCardDetected();
